...
public class ParkingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user = (User) incomingIntent.getSerializableExtra("User");
            ...
            currentLot = new ParkingLot(0, 0, 0, 0);
                ...
                public void onComplete(@Nonnull Task<QuerySnapshot> task) {
                    if (task.isSuccessful()) {
                        ...
                        if (user.getBuilding().equals("Beacon")) {
                            distanceTextView.setText("The distance from this lot to Beacon is");
                        } else if (user.getBuilding().equals("Standish")) {
                            distanceTextView.setText("The distance from this lot to Standish is");
                        } else if (user.getBuilding().equals("LSB")) {
                            distanceTextView.setText("The distance from this lot to the LSB is");
                        }
                    } else {
